...
def analyze_matches():
    pool=[("Man City vs Brentford - 1X","Form iko juu","1.35"),("Arsenal vs Fulham - Over 1.5","Attack kali","1.40"),("Liverpool vs Wolves - Over 1.5","Goli lazima","1.32"),("Real Madrid vs Getafe - 1X","Bernabeu ngumu","1.28"),("Bayern vs Augsburg - 1","Allianz fortress","1.25"),("PSG vs Lorient - Over 1.5","Messi effect","1.33"),("Inter vs Lecce - 1X","San Siro","1.30"),("Barcelona vs Sevilla - Over 1.5","Xavi ball","1.38")]
    random.shuffle(pool)
    ticket=[]; total=1.0
    for m,r,o in pool:
...
async def start(u,c):
    ...
    await u.message.reply_text(f"🔥 V2 LIVE!")
